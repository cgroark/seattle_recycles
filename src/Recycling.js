	...
	render(){
		...
		return(
			...
			{console.log(dataTonn)}
				<h3>Recycling rate (%)<sup>*</sup></h3>
				<LineChart width={400} height={400} data={dataRate}
					margin={{top: 5, right: 20, bottom: 5, left: 0}}>
					<Line type="monotone" dataKey="Rate" stroke="#01764B" />
			...
			<h3>Waste landfilled vs. recycled (tons)<sup>*</sup></h3>
				<BarChart width={600} height={400} data={dataTonn} margin={{top: 20, right: 50, left: 50, bottom: 5}}>
					<Bar dataKey="Landfilled" stackId="a" fill="black" />
					<Bar dataKey="Recycled" stackId="a" fill="#01764B" />
			       	<XAxis dataKey="year"/>
	      	...
	      	<h4 className="footnote"><sup>*</sup>City of Seattle data hosted on Socrata Open Data API</h4>
			</div>
		)
	}
}
